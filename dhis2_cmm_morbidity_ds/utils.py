...
def dhis2_request(session: requests.Session, method: str, url: str, **kwargs: Any) -> dict:
    ...
    Args:
        ...
        **kwargs: Additional keyword arguments to pass to the session.request() method.

    Returns:
        A dictionary containing the JSON response from the request, or an error message if the request fails
    """
    try:
